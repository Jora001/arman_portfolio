      ...
      <div className="w-[80%] mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center">
        <div>
          <h1 className="text-[35px] md:text-[50px] text-white font-bold cursor-pointer">
            HI, <span className="text-blue-400">I&apos;M</span> <span>ARMAN</span>
          </h1>
          <TextEffects />
          <p className="mt-[1.5rem] text-[18px] text-[#CCFFFF]">
          I am Arman, a developer from Yerevan, Armenia, with a passion for technology and innovation. 
          Since 2022, I have been honing my skills in data visualization, web development, and software development, driven by a commitment to creating impactful and efficient solutions.
          Thank you for exploring my portfolio—I look forward to contributing to meaningful projects and advancing in this ever-evolving field.
          ...
          <a
          href="/Arman Haroyan - CV_2025.pdf" // Path to your CV file in the `public` folder
          target="_blank" // Opens the CV in a new browser tab
          ...
          <button className="flex items-center space-x-2">
            <p className="text-[20px] font-semibold w-[2-rem] h-[2rem] hover:text-blue-400 transition-all duration-200 text-white" >My GitHub</p>
